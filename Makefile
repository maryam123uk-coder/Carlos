...
FF_FILES = ImGuiDrawView.mm \
    $(SECURITY_SRC) $(LOADVIEW_SRC) \
    $(IMGUI_SRC) $(wildcard hook/*.c) \
    $(wildcard Hosts/*.m)

FF_FRAMEWORKS = UIKit Foundation Security QuartzCore CoreGraphics \
    CoreText AVFoundation Accelerate GLKit SystemConfiguration
